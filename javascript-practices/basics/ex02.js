/*
    ...
    [객체2] - function type
    1. new FUnction(...) todtjd
    2. var f = function() 함수 리터럴1을 사용해서 생성
    3. function f() 함수 리터럴2을 사용해서 생성
*/
...
// 원시 타입에 메소드가 호출 될 때,
// 임시 Wrapper 객체가 만들어져서 메소드 호출이 일어난 뒤 사하진다. (유사객체)
